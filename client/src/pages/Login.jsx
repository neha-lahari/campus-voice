                ...
                >
                    ...
                    <div className="px-8 pt-6 pb-5" style={{ borderBottom: '1px solid rgba(78,93,120,0.2)' }}>
                        ...
                        <h2
                            ...
                            style={{ fontFamily: "'Orbitron', monospace", color: textMain }}
                        >
                            SYSTEM LOGIN
                        </h2>
                        <p
                    ...
                    <div className="px-8 pt-6 pb-8">
                        <form onSubmit={handleSubmit}>
                            ...
                            {/* Email field */}
                            <div className="mb-4">
                                <div className="flex items-center gap-2 mb-1.5 text-[11px] tracking-[2px]"
                                ...
                                <input
                                    ...
                                    required
                                    className="auth-input w-full py-2.5 px-4 rounded text-sm text-[#c8d4e6] transition-all duration-200"
                                    style={{ fontFamily: "'Share Tech Mono', monospace", background: 'rgba(0,240,255,0.01)', border: '1px solid rgba(0,240,255,0.12)' }}
                                />
                            </div>
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="submit-btn w-full py-3.5 mt-2 rounded text-[12px] font-bold tracking-[5px] transition-all duration-300"
                                style={{ fontFamily: "'Orbitron', monospace", border: `1px solid ${accentPrimary}`, color: accentPrimary, background: 'transparent', cursor: 'pointer' }}
                            >
